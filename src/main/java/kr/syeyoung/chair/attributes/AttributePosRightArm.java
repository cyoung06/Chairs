...
public class AttributePosRightArm extends ChairEntityAttribute<SerializedEulerAngle> {
    public AttributePosRightArm() {
        this.setAttributeValue(new SerializedEulerAngle(0,0,0));
    }
    @Override
    public String getAttributeName() {
        return "pos_right_arm";
    }
    ...
    public boolean applyAttribute(Entity e) {
        if (e instanceof ArmorStand) {
            ((ArmorStand) e).setRightArmPose(getAttributeValue());
            return true;
        }
        return false;
    }
    ...
    public SerializedEulerAngle extractAttribute(Entity e) {
        if (e instanceof ArmorStand) {
            setAttributeValue(new SerializedEulerAngle(((ArmorStand) e).getRightArmPose()));
    ...
    public ChairEntityAttribute<SerializedEulerAngle> clone() {
        return new AttributePosRightArm().setAttributeValue(getAttributeValue());
    }
}
