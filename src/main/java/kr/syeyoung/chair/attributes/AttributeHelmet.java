...
public class AttributeHelmet extends ChairEntityAttribute<ItemStack> {
    @Override
    ...
    public boolean applyAttribute(Entity e) {
        if (e instanceof LivingEntity) {
            ...
            equipment.setHelmet(getAttributeValue());
            return true;
        }
        return false;
    }
    ...
    public ItemStack extractAttribute(Entity e) {
        if (e instanceof LivingEntity) {
            EntityEquipment equipment = ((LivingEntity) e).getEquipment();
            setAttributeValue(equipment.getHelmet());
    ...
    public ChairEntityAttribute<ItemStack> clone() {
        return new AttributeHelmet().setAttributeValue(getAttributeValue());
    }
}
